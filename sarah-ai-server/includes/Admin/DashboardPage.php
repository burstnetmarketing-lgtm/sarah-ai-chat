...
class DashboardPage
{
    ...
    private function renderPage(): void
    {
        ...
        $config   = [
            'apiUrl'          => rest_url('sarah-ai-server/v1'),
        ...
        $appCss = esc_url(SARAH_AI_SERVER_URL . 'assets/dist/app.css?ver=' . SARAH_AI_SERVER_VERSION);
        $appJs  = esc_url(SARAH_AI_SERVER_URL . 'assets/dist/app.js?ver=' . SARAH_AI_SERVER_VERSION);
...
<head>
    ...
    <title><?php echo esc_html(get_bloginfo('name')); ?> — Sarah AI Server</title>
    <link rel="stylesheet" href="<?php echo $appCss; ?>">
</head>
<body>
<div id="app"></div>
<script>window.SarahAiServerConfig = <?php echo wp_json_encode($config); ?>;</script>
