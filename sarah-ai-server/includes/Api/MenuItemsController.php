...
class MenuItemsController
{
    ...
    {
        register_rest_route('sarah-ai-server/v1', '/menu-items', [
        ...
        register_rest_route('sarah-ai-server/v1', '/menu-items/(?P<key>[a-z0-9\-]+)/toggle', [
            'methods' => 'POST', 'callback' => [$this, 'toggle'], 'permission_callback' => [$this, 'can'],
        ]);
        register_rest_route('sarah-ai-server/v1', '/menu-items/(?P<key>[a-z0-9\-]+)/move', [
            'methods' => 'POST', 'callback' => [$this, 'move'], 'permission_callback' => [$this, 'can'],
        ]);
        register_rest_route('sarah-ai-server/v1', '/menu-items/(?P<key>[a-z0-9\-]+)', [
