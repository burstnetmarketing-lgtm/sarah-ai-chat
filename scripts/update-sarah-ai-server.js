// scripts/update-sarah-ai-server.js
// ─────────────────────────────────────────────
// Bumps the version in the sarah-ai-server plugin's main PHP file.
// Usage:
//   npm run update:server [patch|minor|major]
...
const pluginName  = 'sarah-ai-server';
